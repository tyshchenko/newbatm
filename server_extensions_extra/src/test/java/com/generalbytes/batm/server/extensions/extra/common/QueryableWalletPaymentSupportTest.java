...
import com.generalbytes.batm.server.extensions.extra.ethereum.EthPaymentSupport;
...
class QueryableWalletPaymentSupportTest {
    ...
    private final QueryableWalletPaymentSupport paymentSupport = new EthPaymentSupport();
